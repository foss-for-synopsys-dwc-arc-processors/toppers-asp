 ...
 *  true:  dispatcher is not suspended,
...
/*
 *  the list of free task control blocks
 */
QUEUE	free_tcb;
 ...
 *  because 16 priorities are supported in default, bitmap is 16 bit unsigned int(uint16_t).
 *
...
/*
 *  make task un-runnable
 *
 *  when the task with highest precedence is made un-runnable,
