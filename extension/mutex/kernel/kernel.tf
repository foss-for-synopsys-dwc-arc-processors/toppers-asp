...
$		// if ceilpri is not set, set 0 
		$IF !LENGTH(MTX.CEILPRI[mtxid])$
			$MTX.CEILPRI[mtxid] = 0$
		$END$
$		//  if (TMIN_TPRI <= ceilpri && ceilpri <= TMAX_TPRI) is not matched (E_PAR)
...
$	// generate the mutex control block table for all mutexs
