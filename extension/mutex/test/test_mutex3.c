 ...
 * [test purpose]
 *
 *  test the functions of lock and unlock the mutex with priority
 *  ceiling protocol. the function of refering the base priority and
 *  current priority is also tested.
 *
 * [test items]
 *
 ...
 *		(A-3) if the mutex is locked,  the task should be waiting in priority order
 ...
 *	TASK3: high priority
 *	MTX1: mutex (TA_CEILING, the ceiling priority is the high priority)
 *
 * [test sequence]
 *
 *	== TASK1(priority : low)==
