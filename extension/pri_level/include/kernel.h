...
typedef struct t_rpdq {
	...
	ID		rtskid;		/* ID of the task at the head of the priority data queue's receive-wait queue */
	uint_t	spdqcnt;	/* the number of data elements in the priority data queue*/
} T_RPDQ;

typedef struct t_rmbx {
	ID		wtskid;		/* ID of the task at the head of the mailbox's wait queue */
...
#define TA_EDGE			UINT_C(0x02)	/* Edge-triggered */
...
#define TOPPERS_SUPPORT_PRI_LEVEL		/* expansion of task priority range */

/*
 * range of priority
 */
#define TMIN_TPRI		1			/* minimum task priority (the highest)*/
#define TMAX_TPRI		256			/* maximum task priority (the lowest)*/
#define TMIN_DPRI		1			/* minimum data priority (the highest)*/
#define TMAX_DPRI		256			/* maximum data priority (the lowest)*/
#define TMIN_MPRI		1			/* minimum message priority (the highest)*/
#define TMAX_MPRI		256			/* maximum message priority (the lowest)*/
#define TMIN_ISRPRI		1			/* minimum interrupt service routine priority */
#define TMAX_ISRPRI		256			/* maximum interrupt service routine priority */
...
#define TKERNEL_SPVER	UINT_C(0xf513)	/* kernel specification version number */
#define TKERNEL_PRVER	UINT_C(0x1070)	/* kernel version number */

/*
 *  maximum nesting/queueing count
 */
