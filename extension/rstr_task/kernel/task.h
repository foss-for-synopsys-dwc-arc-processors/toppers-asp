...
/*
 *  raise priority of current task
 *
 *  change the priority of current task to newpri(internal representation)．
 *  Also, if necessary, highest priority in the tasks update,
 *  and returns true if in the dispatch-enabled state
