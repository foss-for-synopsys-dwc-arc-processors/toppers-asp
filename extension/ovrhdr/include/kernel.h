...
typedef	ulong_t		OVRTIM;		/* processor time */
...
#define TOVR_STP		UINT_C(0x01)	/* overrun handler is stop */
#define TOVR_STA		UINT_C(0x02)	/* overrun handler is start */
...
#define TOPPERS_SUPPORT_OVRHDR			/* overrun handler is supported */
