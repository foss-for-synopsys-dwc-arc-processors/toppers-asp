...
$	// Fixed-sized Memorypool init block generate
...
$	// if there are more than 1 DEF_OVR (E_OBJ)
$IF LENGTH(OVR.ORDER_LIST) > 1$
	$ERROR$E_OBJ: $FORMAT(_("too many %1%"), "DEF_OVR")$$END$
$END$

$ generated the initialization block table of statically created overrun handlers
