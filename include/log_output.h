 ...
 *  formatted output 
 *
 *  output string in the format specified in format and arguments are
 *  specified in p_arg through the function specified in putc.
 *  
 */
 ...
 *
 *  output the log information specified in p_syslog in string through
 *  the function specified in putc.
 */
extern void	syslog_print(const SYSLOG *p_syslog, void (*putc)(char_t)) throw();

/*
 *  output the log information lost message
 *
 *  output the message that log information lost through the function
 *  specified in putc.
 */
