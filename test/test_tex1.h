 ...
 *  task priority
 */
#define TASK1_PRIORITY	10		/* task1 priority */
#define TASK2_PRIORITY	10		/* task2 priority */
#define TASK3_PRIORITY	10		/* task3 priority */
#define TASK4_PRIORITY	10		/* task4 priority */
