...
/* 
 *		CPU exception test (8)
 *
 * [test purpose]
 *
 * test the system states when cpu exception happens with ipm = 
 * TMAX_INTPRI, dispatch enabled, task exception enabled
 *
 * this test is necessary when TMAX_INTPRI is different with TMIN_INTPRI
 *
 * [test items]
 *
 * when cpu exception happens with ipm = TMAX_INTPRI, dispatch 
 * enabled, task exception enabled
 *
