...
/* 
 *		CPU exception test (10)
 *
 * [test purpose]
 *
 * test the system states when cpu exception happens with ipm = 
 * TMIN_INTPRI-1, dispatch enabled, task exception enabled
 *
 * this test is necessary when ipm can be set with TMIN_INTPRI-1
 *
 * [test items]
 *
 * when cpu exception happens with ipm = TMIN_INTPRI-1, dispatch 
