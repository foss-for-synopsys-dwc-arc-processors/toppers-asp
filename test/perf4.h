 ...
 *   task priority
 */
#define TASK1_PRIORITY	9		/* task1 priority */
#define TASK2_PRIORITY	9		/* task2 priority */
#define TASK3_PRIORITY	11		/* task3 priority */
#define TASK4_PRIORITY	12		/* task4 priority */
#define MAIN_PRIORITY	10		/* main task priority */
